...
class MockDataService {
  ...
  /// Get hotspots data focused on St. Louis
  Future<List<Map<String, dynamic>>> getHotspots() async {
    ...
    return [
      ...
      },
      {
        ...
        'isActive': true,
        'title': 'Forest Park',
        'details': 'Large park area requiring immediate attention',
        'estimated_pounds': 48.7,
      },
      {
        'id': 'stl_hotspot3',
        'location': {'latitude': 38.6337, 'longitude': -90.2000},
        'priority': 'Medium',
        'isActive': true,
        'title': 'Gateway Arch Park',
        'details': 'Tourist area with moderate litter',
        'estimated_pounds': 22.3,
      },
      {
        'id': 'stl_hotspot4',
        'location': {'latitude': 38.6117, 'longitude': -90.2595},
        'priority': 'High',
        'isActive': true,
        'title': 'Tower Grove Park',
        'details': 'Popular park with significant waste',
        'estimated_pounds': 42.8,
      },
      {
        'id': 'stl_hotspot5',
        'location': {'latitude': 38.6353, 'longitude': -90.2846},
        'priority': 'Medium',
        'isActive': true,
        'title': 'The Delmar Loop',
        'details': 'Entertainment district with moderate litter',
        'estimated_pounds': 28.5,
      },
      {
        'id': 'stl_hotspot6',
        'location': {'latitude': 38.6321, 'longitude': -90.2243},
        'priority': 'Low',
        'isActive': true,
        'title': 'Lafayette Square',
        'details': 'Historic neighborhood with light litter',
        'estimated_pounds': 12.6,
      },
      {
        'id': 'stl_hotspot7',
        'location': {'latitude': 38.5816, 'longitude': -90.2339},
        'priority': 'High',
        'isActive': true,
        'title': 'Cherokee Street',
        'details': 'Business district with significant waste',
        'estimated_pounds': 37.9,
      },
      {
        'id': 'stl_hotspot8',
        'location': {'latitude': 38.6047, 'longitude': -90.2938},
        'priority': 'Critical',
        'isActive': true,
        'title': 'Carondelet Park',
        'details': 'Large park with critical waste situation',
        'estimated_pounds': 53.1,
      },
      {
        'id': 'stl_hotspot9',
        'location': {'latitude': 38.6182, 'longitude': -90.2048},
        'priority': 'High',
        'isActive': true,
        'title': 'Soulard Market',
        'details': 'Historic market area with tourist traffic',
